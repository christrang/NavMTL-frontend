...
import com.example.frontend.databinding.ActivityCustomtripBinding
import com.example.frontend.databinding.TriprogresscustomlayoutBinding
...
class CustomTripProgressActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityCustomtripBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCustomtripBinding.inflate(layoutInflater)
...
class MyTripProgressComponent(
    private val binding: TriprogresscustomlayoutBinding
) : UIComponent() {
...
class MyTripProgressViewBinder : UIBinder {
    override fun bind(viewGroup: ViewGroup): MapboxNavigationObserver {
        val scene = Scene.getSceneForLayout(
            viewGroup,
            R.layout.activity_navigation_view,
            viewGroup.context
        )
        TransitionManager.go(scene, Fade())

        val binding = TriprogresscustomlayoutBinding.bind(viewGroup)
